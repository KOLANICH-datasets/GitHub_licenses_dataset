...
[this repo is all about](https://choosealicense.com/about). It’s not a comprehensive list of all possible licenses. 
...
* Licenses live in the `/licenses` folder.
* The license files should be in the format of `licenses/[lowercased-spdx-id].txt` (e.g., `licenses/mit.txt`)
